...
public class Ach extends Activity implements View.OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,af,ach,abg,abh;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a_charged);
        ...
        abg = (ImageButton) findViewById(R.id.abg);
        abg.setOnClickListener(this);
        abh = (ImageButton) findViewById(R.id.abh);
        abh.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.abg:
                isLeftExpanded=false;
                Intent abg_it = new Intent(this, Artd.class);
                startActivity(abg_it);
                break;
            case R.id.abh:
                isLeftExpanded=false;
                Intent abh_it = new Intent(this, Artc.class);
                startActivity(abh_it);
                break;
        }
    }
}