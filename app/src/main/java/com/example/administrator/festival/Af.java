...
public class Af extends Activity implements View.OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,af,ach,abe,abf;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a_free);
        ...
        abe = (ImageButton) findViewById(R.id.abe);
        abe.setOnClickListener(this);
        abf = (ImageButton) findViewById(R.id.abf);
        abf.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.abe:
                ...
                Intent abe_it = new Intent(this, Artb.class);
                startActivity(abe_it);
                break;
            case R.id.abf:
                isLeftExpanded=false;

                Intent abf_it = new Intent(this, Arta.class);
                startActivity(abf_it);
                break;
        }
    }
}