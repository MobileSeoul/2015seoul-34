...
public class Art extends Activity implements OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,af,ach,aba,abb,abc,abd;
    @Override
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mainB:
                isLeftExpanded=false;
                finish();
                Intent main_it = new Intent(Art.this, Startmain.class);
                startActivity(main_it);
                break;
            case R.id.musicB:
                isLeftExpanded=false;
                finish();
                Intent music_it = new Intent(Art.this, Music.class);
                startActivity(music_it);
                break;
            case R.id.artB:
                isLeftExpanded=false;
                finish();
                Intent art_it = new Intent(Art.this, Art.class);
                startActivity(art_it);
                break;
            case R.id.playB:
                isLeftExpanded=false;
                finish();
                Intent play_it = new Intent(Art.this, Play.class);
                startActivity(play_it);
                break;
            case R.id.natureB:
                isLeftExpanded=false;
                finish();
                Intent nature_it = new Intent(Art.this, Nature.class);
                startActivity(nature_it);
                break;
            case R.id.etcB:
                isLeftExpanded=false;
                finish();
                Intent etc_it = new Intent(Art.this, Etc.class);
                startActivity(etc_it);
                break;
            case R.id.noticeB:
                isLeftExpanded=false;
                finish();
                Intent notice_it = new Intent(Art.this, Notice.class);
                startActivity(notice_it);
                break;
            case R.id.epilogueB:
                isLeftExpanded=false;
                finish();
                Intent epilogue_it = new Intent(Art.this, Epilogue.class);
                startActivity(epilogue_it);
                break;
            case R.id.homeB:
                isLeftExpanded=false;
                finish();
                Intent home_it = new Intent(Art.this, Startmain.class);
                startActivity(home_it);
                break;
            case R.id.af:
                isLeftExpanded=false;

                Intent af_it = new Intent(this, Af.class);
                startActivity(af_it);
                break;
            case R.id.ach:
                isLeftExpanded=false;

                Intent ach_it = new Intent(this, Ach.class);
                startActivity(ach_it);
                break;
            case R.id.aba:
                isLeftExpanded=false;
                Intent aba_it = new Intent(this, Artd.class);
                startActivity(aba_it);
                break;
            case R.id.abb:
                isLeftExpanded=false;
                Intent abb_it = new Intent(this, Artb.class);
                startActivity(abb_it);
                break;
            case R.id.abc:
                isLeftExpanded=false;
                Intent abc_it = new Intent(this, Arta.class);
                startActivity(abc_it);
                break;
            case R.id.abd:
                isLeftExpanded=false;
                Intent abd_it = new Intent(this, Artc.class);
                startActivity(abd_it);
                break;
        }
    }
}