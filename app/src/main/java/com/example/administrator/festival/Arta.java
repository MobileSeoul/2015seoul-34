...
public class Arta extends Activity implements View.OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-120"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://seoullantern.visitseoul.net"));
        startActivity(intent);
    }
