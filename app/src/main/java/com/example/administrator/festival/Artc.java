...
public class Artc extends Activity implements View.OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-3216-1185"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://sidance.org"));
        startActivity(intent);
    }
