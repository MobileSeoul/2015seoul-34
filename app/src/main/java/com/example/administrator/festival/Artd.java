...
public class Artd extends Activity implements View.OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-2270-1233"));
