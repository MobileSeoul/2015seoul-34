...
public class Etc extends Activity implements OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,ef,ech, eba,ebb,ebc,ebd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eba = (ImageButton) findViewById(R.id.eba);
        eba.setOnClickListener(this);
        ebb = (ImageButton) findViewById(R.id.ebb);
        ebb.setOnClickListener(this);
        ebc = (ImageButton) findViewById(R.id.ebc);
        ebc.setOnClickListener(this);
        ebd = (ImageButton) findViewById(R.id.ebd);
        ebd.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.eba:
                isLeftExpanded=false;
                Intent eba_it = new Intent(this, Etca.class);
                startActivity(eba_it);
                break;
            case R.id.ebb:
                isLeftExpanded=false;
                Intent ebb_it = new Intent(this, Etcb.class);
                startActivity(ebb_it);
                break;
            case R.id.ebc:
                isLeftExpanded=false;
                Intent ebc_it = new Intent(this, Etcc.class);
                startActivity(ebc_it);
                break;
            case R.id.ebd:
                isLeftExpanded=false;
                Intent ebd_it = new Intent(this, Etcd.class);
                startActivity(ebd_it);
                break;
        }
    }
}