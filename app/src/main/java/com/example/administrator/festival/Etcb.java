...
public class Etcb extends Activity implements OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-2265-2247"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://plaza.seoul.go.kr/gwanghwamun"));
        startActivity(intent);
    }
