...
public class Etcc extends Activity implements OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-927-6603"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.sharingkorea.net"));
        startActivity(intent);
    }
