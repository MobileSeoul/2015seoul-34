...
public class Mch extends Activity implements View.OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,mf,mch,mbc,mbd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.m_charged);
        ...
        mf = (ImageButton) findViewById(R.id.mf);
        mf.setOnClickListener(this);
        mch = (ImageButton) findViewById(R.id.mch);
        mch.setOnClickListener(this);
        mbc = (ImageButton) findViewById(R.id.mbc);
        mbc.setOnClickListener(this);
        mbd = (ImageButton) findViewById(R.id.mbd);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mf:
                isLeftExpanded=false;
                Intent mf_it = new Intent(this, Mf.class);
                startActivity(mf_it);
                break;
            case R.id.mch:
                isLeftExpanded=false;
                Intent mch_it = new Intent(this, Mch.class);
                startActivity(mch_it);
                break;
            case R.id.mbc:
                isLeftExpanded=false;
                Intent mba_it = new Intent(this, Musicb.class);
                startActivity(mba_it);
                break;
            case R.id.mbd:
                isLeftExpanded=false;
                Intent mbb_it = new Intent(this, Musica.class);
                startActivity(mbb_it);
                break;
        }
    }
}