...
public class Musicb extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.musicb);
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.gpsfestival.com"));
