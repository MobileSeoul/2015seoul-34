...
public class Nature extends Activity implements OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,nf,nch,nba,nbb;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nba = (ImageButton) findViewById(R.id.nba);
        nba.setOnClickListener(this);
        nbb = (ImageButton) findViewById(R.id.nbb);
        nbb.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.nba:
                isLeftExpanded=false;
                Intent nba_it = new Intent(this, Naturea.class);
                startActivity(nba_it);
                break;
            case R.id.nbb:
                isLeftExpanded=false;
                Intent nbb_it = new Intent(this, Natureb.class);
                startActivity(nbb_it);
                break;
