...
public class Pf extends Activity implements OnClickListener {
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,pf,pch, pbd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.p_free);
        ...
        pbd = (ImageButton) findViewById(R.id.pbd);
        pbd.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.pbd:
                isLeftExpanded=false;
                Intent pbd_it = new Intent(this, Playb.class);
                startActivity(pbd_it);
                break;
        }
    }
}