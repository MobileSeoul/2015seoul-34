...
public class Play extends Activity implements OnClickListener {
   ...
   private FrameLayout.LayoutParams slidingPanelParameters;
    ...
    private ImageButton mainB,musicB,artB,playB,natureB,etcB,noticeB,epilogueB,homeB,pf,pch, pba,pbb,pbc;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pba = (ImageButton) findViewById(R.id.pba);
        pba.setOnClickListener(this);

        pbb = (ImageButton) findViewById(R.id.pbb);
        pbb.setOnClickListener(this);

        pbc = (ImageButton) findViewById(R.id.pbc);
        pbc.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.pba:
                isLeftExpanded=false;
                Intent pba_it = new Intent(this, Playb.class);
                startActivity(pba_it);
                break;
            case R.id.pbb:
                isLeftExpanded=false;
                Intent pbb_it = new Intent(this, Playa.class);
                startActivity(pbb_it);
                break;
            case R.id.pbc:
                isLeftExpanded=false;
                Intent pbc_it = new Intent(this, Playc.class);
                startActivity(pbc_it);
                break;
        }
    }
}