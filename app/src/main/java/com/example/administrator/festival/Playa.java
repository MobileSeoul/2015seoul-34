...
public class Playa extends Activity implements OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-411-2000"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.lotteworld.com"));
        startActivity(intent);
    }
