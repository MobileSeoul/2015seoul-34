...
public class Playb extends Activity implements OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:02-450-1114"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.gwangjin.go.kr"));
        startActivity(intent);
    }
}