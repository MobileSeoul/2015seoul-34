...
public class Playc extends Activity implements OnClickListener {
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:010-4848-3428"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/2015shinchonbeer"));
        startActivity(intent);
    }
}